...
public class RenderTransformer implements IClassTransformer {
    ...
    public static void patchRenderItem(ClassNode classNode) {
        ...
        toInsert3.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "me/creepinson/creepinoutils/api/util/client/IItemRendererHandler", "renderItemStack", new MCPSidedString("(Lnet/minecraft/item/ItemStack;Lnet/minecraft/client/renderer/block/model/IBakedModel;)V", "(LainLcfw;)V").toString(), false));
        ...
        toInsert2.add(new FieldInsnNode(178, "me/creepinson/creepinoutils/api/util/client/IItemRendererHandler", "allowEnchants", "Z"));
    ...
    public static void patchCameraTransform(ClassNode classNode) {
        ...
        toInsert.add(new MethodInsnNode(184, "me/creepinson/creepinoutils/api/util/client/IItemRendererHandler", "handleCameraTransforms", "(Lnet/minecraft/client/renderer/block/model/ItemCameraTransforms$TransformType;Z)V", false));
        toInsert.add(new FieldInsnNode(178, "me/creepinson/creepinoutils/api/util/client/IItemRendererHandler", "runTransforms", "Z"));
        LabelNode l1 = new LabelNode();
    ...
    public static void patchMinecraft(ClassNode classNode) {
        ...
        InsnList toInsert = new InsnList();
        toInsert.add(new TypeInsnNode(187, "me/creepinson/creepinoutils/api/util/client/RenderItemObj"));
        toInsert.add(new InsnNode(89));
        method.instructions.insert(start, toInsert);
        method.instructions.insert(end, new MethodInsnNode(183, "me/creepinson/creepinoutils/api/util/client/RenderItemObj", "<init>", "(Lnet/minecraft/client/renderer/RenderItem;)V", false));
    }
    ...
    public static void patchRenderManager(ClassNode classNode) {
        ...
        InsnList toInsert = new InsnList();
        toInsert.add(new VarInsnNode(25, 1));
        toInsert.add(new MethodInsnNode(184, "me/creepinson/creepinoutils/api/util/client/IItemRendererHandler", "updateLastPossiblePos", "(Lnet/minecraft/entity/Entity;)V", false));
    ...
    public static void patchTextureManager(ClassNode classNode) {
        ...
        InsnList toInsert = new InsnList();
        toInsert.add(new FieldInsnNode(178, "me/creepinson/creepinoutils/api/util/client/IItemRendererHandler", "canBind", "Z"));
        LabelNode l1 = new LabelNode();
        toInsert.add(new JumpInsnNode(154, l1));
        LabelNode l2 = new LabelNode();
        toInsert.add(l2);
