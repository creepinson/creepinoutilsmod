...
public class CreepinoUtils {
    ...
    /**
     * Sets entity velocity forward in a direction.
     *
     * @param entity
     * @param direction An EnumFacing direction
     * @see #entityAccelerate(Entity entity, EnumFacing direction) See entityAccelerate for adding to an entities velocity.
     */
    public static void entityVelocity(Entity entity, EnumFacing direction) {
        entityVelocity(entity, direction, 0.1);
    }

    public static void entityVelocity(Entity entity, EnumFacing direction, double speed) {
        switch (direction) {
            case DOWN:
                setVelocity(entity, 0, -speed, 0);
            case UP:
                setVelocity(entity, 0, speed, 0);
            case NORTH:
                setVelocity(entity, 0, 0, -speed);
            case SOUTH:
                setVelocity(entity, 0, 0, speed);
            case EAST:
                setVelocity(entity, -speed, 0, 0);
            case WEST:
                setVelocity(entity, speed, 0, 0);
        }
    }
    ...
    /**
     * ADDS to entity velocity forward in a direction.
     *
     * @param entity
     * @param direction An EnumFacing direction
     */
    public static void entityAccelerate(Entity entity, EnumFacing direction) {
        entityAccelerate(entity, direction, 0.1);
    }

    public static void entityAccelerate(Entity entity, EnumFacing direction, double speed) {
        switch (direction) {
            case DOWN:
                addVelocity(entity, 0, -speed, 0);
            case UP:
                addVelocity(entity, 0, speed, 0);
            case NORTH:
                addVelocity(entity, 0, 0, -speed);
            case SOUTH:
                addVelocity(entity, 0, 0, speed);
            case EAST:
                addVelocity(entity, -speed, 0, 0);
            case WEST:
                addVelocity(entity, speed, 0, 0);
        }
    }

    public static void setVelocity(Entity entity, double mx, double my, double mz) {
        entity.motionX = mx;
        entity.motionY = my;
        entity.motionZ = mz;
