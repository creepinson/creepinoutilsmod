package me.creepinson.creepinoutils.util.util.client.gui;
...
public abstract class Scrollbar extends GuiButton {
    ...
    public void drawButton(Minecraft mc, int x, int y, float partialTicks) {
        ...
        int bottom = y + height;
        Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("/gui/allitems.png"));
