package me.creepinson.creepinoutils.util.util.animation;
...
public abstract class AnimationKey {
    ...
    public static final AnimationKey translationX = new TranslationKey("transX", Axis.X);
    public static final AnimationKey translationY = new TranslationKey("transY", Axis.Y);
    public static final AnimationKey translationZ = new TranslationKey("transZ", Axis.Z);
    ...
    public static class TranslationKey extends AnimationKey {

        public final Axis axis;

        TranslationKey(String name, Axis axis) {
            super(name);
            this.axis = axis;
        }
