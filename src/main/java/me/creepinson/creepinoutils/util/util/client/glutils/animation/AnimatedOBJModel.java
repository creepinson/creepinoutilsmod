...
package me.creepinson.creepinoutils.util.util.client.glutils.animation;
...
import me.creepinson.creepinoutils.util.util.animation.AnimationGroup;
import me.creepinson.creepinoutils.util.util.animation.AnimationKey;
import me.creepinson.creepinoutils.util.util.animation.AnimationState;
...
public class AnimatedOBJModel implements IModel {
    ...
    private AnimationGroup currentAnimation;
    ...
    public void setCurrentAnimation(AnimationGroup animation) {
