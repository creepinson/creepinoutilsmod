...
public interface IItemRenderer {
    ...
    /**
     * This is your rendering you can render vanilla by using {@link me.creepinson.creepinoutils.util.client.IItemRendererHandler#renderItemStack(ItemStack, IBakedModel) or IItemRendererHandler#renderModel(ItemStack, IBakedModel)}
     * return false to stop vanilla rendering the itemstack
     *
     * @param stack        {@link ItemStack} that will be rendered
...
//	public boolean allowRPOverride(ItemStack itemstack, IBakedModel model, TransformType type);
     ...
     *
     * @param stack     {@link ItemStack} where data for overlay rendering will be taken
