...
public class EnergyConfigHandler {
    ...
    private static void initialiseRF() {
        ...
        if ((count + count2 == 3 && count2 != 1) || count + count2 == 5) {
            ...
            CreepinoUtilsMod.getInstance().getLogger().error("Incomplete Redstone Flux API detected: Galacticraft will not support RF energy connections until this is fixed.");
        }
    }
